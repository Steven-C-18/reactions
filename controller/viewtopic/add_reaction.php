...
class add_reaction
{
	...
	// lets get this file finished in 0.9.6
...
// this is a global phpbb option... i think its available from core.page_header()
	private function get_active_foe($user_id)
	{
		if (empty($user_id))
		{
			return false;
		...
		return (bool) $row['foe'] ? true : false;
	}
