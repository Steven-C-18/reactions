...
class m1_tp_reactions extends \phpbb\db\migration\migration
{
	...
	public function update_data()
	{
		return [
			...
			['config.add', ['reactions_resync_enable', true]],
			...
			['config.add', ['reactions_enable_traffic_light', true]],
		...
		return [
			'add_tables'		=> [
				$this->table_prefix . 'reactions'	=> [
					'COLUMNS'		=> [
						...
						'reaction_traffic_light'	=> ['INT:1', 0],
					],
				...
				$this->table_prefix . 'reaction_types'	=> [
					'COLUMNS'		=> [
						...
						'reaction_type_traffic_light'	=> ['INT:1', 0],
						'reaction_type_tl_run'			=> ['BOOL', 0],						
					],
			...
			'add_columns'	=> [
				...
				$this->table_prefix . 'users'	=> [
					...
					'user_enable_foe_reactions'		=> ['BOOL', 0],
					'user_enable_post_reactions'	=> ['BOOL', 1],
					'user_enable_topic_reactions'	=> ['BOOL', 1],
					'user_reactions_negative'		=> ['INT:9', 0],
					'user_reactions_neutral'		=> ['INT:9', 0],
					'user_reactions_positive'		=> ['INT:9', 0],					
				],				
			],
		];
	}
		...
		return [
			'drop_columns'	=> [
				...
				$this->table_prefix . 'users'		=> [
					...
					'user_reactions_negative',
					'user_reactions_neutral',
					'user_reactions_positive',	
				],				
			],
